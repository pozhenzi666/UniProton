...
/* 最大可支持的核数，单位：个 */
#define OS_SYS_CORE_MAX_NUM                             1
/* 主核ID */
#define OS_SYS_CORE_PRIMARY                             0

/* ***************************** 中断模块配置 ************************** */
/* 硬中断最大支持个数 */
#define OS_HWI_MAX_NUM_CONFIG                           275
...
/* 最大支持的任务数,最大共支持254个 */
#define OS_TSK_MAX_SUPPORT_NUM                          64
/* 缺省的任务栈大小 */
...
/* 私有FSC内存分区大小 */
#define OS_MEM_FSC_PT_SIZE                              0x40000
...
/* GIC基地址配置 */
#define OS_GIC_BASE_ADDR                                0xF5411000U
/* GICR相对于GIC基地址偏移量配置 这个D9 secure核用不到*/
#define OS_GICR_OFFSET                                  0x20000U
/* GICR核间偏移量配置  这个D9 secure核用不到 */
