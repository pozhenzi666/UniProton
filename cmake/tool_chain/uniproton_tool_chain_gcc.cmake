...
if(${CPU_TYPE} STREQUAL "d9_secure")
        set(CMAKE_ASM_FLAGS "--specs=nosys.specs")
        set(CMAKE_C_FLAGS "--specs=nosys.specs") #原ID形式\"888888\"
        set(CMAKE_C_COMPILE_OBJECT "<CMAKE_C_COMPILER> -O2 -pipe ")
        ...
        set(CMAKE_C_COMPILE_OBJECT "${CMAKE_C_COMPILE_OBJECT} ${STRONG_COMPILE_WARING_FLAG} ${COMPILE_WARING_FLAG} -std=gnu11 -fno-common -fomit-frame-pointer -mcpu=cortex-r5 -mthumb  -D__thumb__ -mfloat-abi=soft -mfpu=fpv4-sp-d16    -fstack-protector-strong  -fdata-sections  -ffunction-sections -fshort-enums  -funsigned-char -DSECUREC_BUFFER_SIZE=32 <FLAGS> <INCLUDES> -c <SOURCE> -o <OBJECT>")
        set(CMAKE_ASM_COMPILE_OBJECT "<CMAKE_ASM_COMPILER>  -O2  -pipe ${STRONG_COMPILE_WARING_FLAG} ${COMPILE_WARING_FLAG} -std=gnu11 -fno-common -fomit-frame-pointer -mthumb -D__thumb__ -mcpu=cortex-r5 -mfloat-abi=soft -mfpu=fpv4-sp-d16  -Wa,-mimplicit-it=thumb  -fstack-protector-strong  -funsigned-char  <FLAGS> <INCLUDES> -c <SOURCE> -o <OBJECT>")
endif()
