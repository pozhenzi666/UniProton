...
add_library(SD3403  STATIC "${GUEST_SRCS}")
...
####以下为make install打包脚本#####
set(sd3403_armv8_export modules)
...
set(INSTALL_SD3403_ARMV8_BASE_DIR                 .)
set(INSTALL_SD3403_ARMV8_INCLUDE_DIR              UniProton/include)
set(INSTALL_SD3403_ARMV8_ARCHIVE_DIR              UniProton/lib/sd3403)
set(INSTALL_SD3403_ARMV8_ARCHIVE_SEC_DIR          libboundscheck/lib/sd3403)
set(INSTALL_SD3403_ARMV8_ARCHIVE_CONFIG_DIR       UniProton/config)
set(INSTALL_SD3403_ARMV8_CONFIG_DIR               cmake/sd3403)


include(CMakePackageConfigHelpers)
configure_package_config_file(${PROJECT_SOURCE_DIR}/cmake/tool_chain/sd3403_armv8_config.cmake.in
	${CMAKE_CURRENT_BINARY_DIR}/uniproton-sd3403-armv8-config.cmake
	INSTALL_DESTINATION ${INSTALL_SD3403_ARMV8_CONFIG_DIR}
	PATH_VARS
	INSTALL_SD3403_ARMV8_BASE_DIR
	INSTALL_SD3403_ARMV8_INCLUDE_DIR
	INSTALL_SD3403_ARMV8_ARCHIVE_DIR
	INSTALL_SD3403_ARMV8_ARCHIVE_SEC_DIR
	INSTALL_SD3403_ARMV8_ARCHIVE_CONFIG_DIR
	INSTALL_SD3403_ARMV8_CONFIG_DIR
	INSTALL_PREFIX ${CMAKE_INSTALL_PREFIX}
)
install(EXPORT ${sd3403_armv8_export}
		NAMESPACE UniProton::
		FILE uniproton-sd3403-armv8-targets.cmake
		DESTINATION ${INSTALL_SD3403_ARMV8_CONFIG_DIR}
)
install(FILES
	${CMAKE_CURRENT_BINARY_DIR}/uniproton-sd3403-armv8-config.cmake
	DESTINATION ${INSTALL_SD3403_ARMV8_CONFIG_DIR}
...
install(TARGETS
	CortexMXsec_c
	EXPORT ${sd3403_armv8_export}
	ARCHIVE DESTINATION ${INSTALL_SD3403_ARMV8_ARCHIVE_SEC_DIR}
)

install(TARGETS
	SD3403
	EXPORT ${sd3403_armv8_export}
	ARCHIVE DESTINATION ${INSTALL_SD3403_ARMV8_ARCHIVE_DIR}/
)
...
install(FILES
	${PROJECT_SOURCE_DIR}/build/uniproton_config/config_armv8_sd3403/prt_buildef.h
	DESTINATION ${INSTALL_SD3403_ARMV8_ARCHIVE_CONFIG_DIR}/sd3403
)
...
if (NOT "${LIBCK_INSTALL_FILE_OPTION}" STREQUAL "SUPER_BUILD")
	...
	install(FILES
		...
		DESTINATION ${INSTALL_SD3403_ARMV8_ARCHIVE_CONFIG_DIR}
	)
    ##{GLOB 所有文件 | GLOB_RECURSE 递归查找文件&文件夹}
	file(GLOB common_include_files  ${PROJECT_SOURCE_DIR}/src/include/uapi/common/*.h)
	install(FILES
		${common_include_files}
		DESTINATION ${INSTALL_SD3403_ARMV8_INCLUDE_DIR}/common
	)
	...
	install(FILES
		...
		DESTINATION ${INSTALL_SD3403_ARMV8_INCLUDE_DIR}/hw/board
	)
	...
	install(FILES
		...
		DESTINATION ${INSTALL_SD3403_ARMV8_INCLUDE_DIR}/hw/cpu
	)
	...
	install(FILES
		...
		DESTINATION ${INSTALL_SD3403_ARMV8_INCLUDE_DIR}/hw/drv
	)
	...
	install(FILES
		...
		DESTINATION ${INSTALL_SD3403_ARMV8_INCLUDE_DIR}/
	)
endif()