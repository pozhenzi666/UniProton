...
foreach(FILE_NAME ${ALL_OBJECT_LIBRARYS})
    list(APPEND CORTEX_R5_D9_SECURE_SRCS
...
#编译.a库
add_library(D9_SECURE  STATIC "${CORTEX_R5_D9_SECURE_SRCS}")
set_target_properties(D9_SECURE PROPERTIES SUFFIX ".a")
...
####以下为d9_secure make install打包脚本#####
set(d9_secure_cortex_r5_export modules)
...
set(INSTALL_D9_SECURE_CORTEX_R5_BASE_DIR               .)
set(INSTALL_D9_SECURE_CORTEX_R5_INCLUDE_DIR            UniProton/include)
set(INSTALL_D9_SECURE_CORTEX_R5_INCLUDE_SEC_DIR        libboundscheck/include)
set(INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_DIR            UniProton/lib/d9_secure)
set(INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_SEC_DIR        libboundscheck/lib/d9_secure)
set(INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_CONFIG_DIR     UniProton/config)
set(INSTALL_D9_SECURE_CORTEX_R5_CONFIG_DIR             cmake/d9_secure)




include(CMakePackageConfigHelpers)
configure_package_config_file(${PROJECT_SOURCE_DIR}/cmake/tool_chain/d9_secure-cortex_r5-config.cmake.in
    ${CMAKE_CURRENT_BINARY_DIR}/UniProton-d9_secure-cortex_r5-config.cmake
    INSTALL_DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_CONFIG_DIR}
    PATH_VARS
    INSTALL_D9_SECURE_CORTEX_R5_BASE_DIR
    INSTALL_D9_SECURE_CORTEX_R5_INCLUDE_DIR
    INSTALL_D9_SECURE_CORTEX_R5_INCLUDE_SEC_DIR
    INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_DIR
    INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_SEC_DIR
    INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_CONFIG_DIR
    INSTALL_D9_SECURE_CORTEX_R5_CONFIG_DIR
    INSTALL_PREFIX ${CMAKE_INSTALL_PREFIX}
)
install(EXPORT ${d9_secure_cortex_r5_export}
        NAMESPACE UniProton::
        FILE UniProton-d9_secure-cortex_r5-targets.cmake
        DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_CONFIG_DIR}
)
install(FILES
    ${CMAKE_CURRENT_BINARY_DIR}/UniProton-d9_secure-cortex_r5-config.cmake
    DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_CONFIG_DIR}
...
install(TARGETS
    D9_SECURE
    EXPORT ${d9_secure_cortex_r5_export}
    ARCHIVE DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_DIR}/
)
...
if (${COMPILE_OPTION} STREQUAL "coverity" OR ${COMPILE_OPTION} STREQUAL "fortify" OR ${COMPILE_OPTION} STREQUAL "UniProton")
    ...
    if (NOT "${RPROTON_INSTALL_FILE_OPTION}" STREQUAL "SUPER_BUILD")
        ...
        install(FILES
            ${glob_sec_files}
            DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_SEC_DIR}
        )
    endif()
endif()

install(FILES
    ${PROJECT_SOURCE_DIR}/build/uniproton_config/config_cortex_r5_d9_secure/prt_buildef.h
    DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_CONFIG_DIR}/d9_secure/
)
if (NOT "${RPROTON_INSTALL_FILE_OPTION}" STREQUAL "SUPER_BUILD")
    ##{GLOB 所有文件 | GLOB_RECURSE 递归查找文件&文件夹}
    ...
    install(FILES
        ...
        DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_ARCHIVE_CONFIG_DIR}
    )
    ...
    install(FILES
        ...
        DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_INCLUDE_DIR}/hw/armv7-r
    )
    ...
    install(FILES
        ...
        DESTINATION ${INSTALL_D9_SECURE_CORTEX_R5_INCLUDE_DIR}/
    )
endif()
